 ...
 * @ORM\Table(name="film_category", indexes={@ORM\Index(name="fk_film_category_category", columns={"category_id"}), @ORM\Index(name="fk_film_category_film", columns={"film_id"})})
 */
class FilmCategory
{
    /**
